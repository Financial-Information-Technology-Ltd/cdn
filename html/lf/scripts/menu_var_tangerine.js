...
***********************************************************************************/
  var LowBgColor='#FF9100';     // Background color when mouse is not over
  var LowSubBgColor=lighter;      // Background color when mouse is not over on subs
  var HighBgColor='#FF9100'; ;      // Background color when mouse is over
  var HighSubBgColor='#7CBB0E';     // Background color when mouse is over on subs
  var FontLowColor='#FFFFFF';     // Font color when mouse is not over
  var FontSubLowColor='#FF9100';      // Font color subs when mouse is not over
  var FontHighColor='#345200';      // Font color when mouse is over
