...
if (CurrntOvr!=null && CurrntOvr==this) return;
  if(!Loadd||!Creatd) return;
  var HP=Nav4?this.LowLyr:this;
  IniFlg=0;
  CurrntOvr=this;
...
function MbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
  ...
  this.style.cursor=ExpYes&&(this.LinkTxt||(UnfoldsOnClick))?'hand':'default';
  this.ro=0;
  ...
  if(ExpYes){this.onselectstart=CnclSlct;
    this.onmouseover=UnfoldsOnClick?OpenMenuClick:OpenMenu;
    this.onmouseout=CloseMenu;
    this.onclick=UnfoldsOnClick&&eval(WhatMenu+'[3]')?OpenMenu:GoTo }
...
UnfoldsOnClick&&eval(WhatMenu+'[3]')?this.addEventListener('click',OpenMenu,false):this.addEventListener('click',GoTo,false)}}
...
function NavMbrSetUp(MmbrCntnr,PrMmbr,WhatMenu,Wdth,Hght){
  ...
  this.CmdLyr.onmouseover=UnfoldsOnClick?OpenMenuClick:OpenMenu;
  this.CmdLyr.onmouseout=CloseMenu;
  this.CmdLyr.captureEvents(Event.MOUSEUP);
  this.CmdLyr.onmouseup=UnfoldsOnClick&&eval(WhatMenu+'[3]')?OpenMenu:GoTo;
