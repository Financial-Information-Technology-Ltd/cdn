...
var LowSubBgColor = lighter; // Background color when mouse is not over on
								// subs
...
var MenuTextCentered = 'left'; // Item text position 'left', 'center' or
								// 'right'
var MenuCentered = 'left'; // Menu horizontal position 'left', 'center' or
							// 'right'
...
var Arrws = [ '/lf/images/right.png', 16, 16, '/lf/images/down.png', 16, 16,
		'/lf/images/trileft.gif', 5, 10 ]; // Arrow source, width and height
